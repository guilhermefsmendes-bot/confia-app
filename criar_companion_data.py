...
print()
print("=" * 70)
print("COMPANHEIRO CONFIA — CAMADA DE DADOS")
print("=" * 70)
print()
print(f"✓ Criado: {path}")
print()
print("Esta camada apenas LÊ:")
print("  • confia_ratings_v2")
print("  • confia_objectives_history")
print("  • confia_habits_daily")
print("  • confia_impulso_history")
print("  • confia_daily_checkin_history")
print("  • confia_avatar")
print()
print("Nenhum sistema existente foi alterado.")
print("=" * 70)
