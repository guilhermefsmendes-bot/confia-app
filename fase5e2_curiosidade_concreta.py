...
BACKUPS = {
    APP:
        Path("/tmp/App.tsx.before_fase5e2_curiosidade_concreta"),

    LOCALES["pt"]:
        Path("/tmp/pt.json.before_fase5e2_curiosidade_concreta"),

    LOCALES["en"]:
        Path("/tmp/en.json.before_fase5e2_curiosidade_concreta"),

    LOCALES["es"]:
        Path("/tmp/es.json.before_fase5e2_curiosidade_concreta"),

    LOCALES["fr"]:
        Path("/tmp/fr.json.before_fase5e2_curiosidade_concreta"),
}
...
def fail(message):
    print()
    print("=" * 78)
    print("ERRO — FASE 5E.2 NÃO APLICADA")
    print("=" * 78)
    print()
    print(message)
    print()
...
# ============================================================
# 4. BLOCO 5D ATUAL EXATO
#
# Substituímos APENAS o conteúdo textual da 5D.
# Estrutura visual permanece igual.
# ============================================================
...
# 5. NOVO CONTEÚDO
#
# Não adicionamos outro componente.
#
# O mesmo <p> da 5D passa a preferir uma observação
# concreta quando a memória já a sustenta.
#
# IMPORTANTE:
# homeNowMemory é discriminada por kind.
# Cada campo é usado apenas no ramo onde existe.
# ============================================================
                 ...
                 homeNowMemory.needCount >= 2
                  ...
                  : homeNowMemory?.kind === "continuity" &&
                    ...
                    ? t(
                        ...
                        {
                          count: homeNowMemory.repeatedNeedCount,
                        }
                      )
                    : homeNowMemory?.kind === "continuity" &&
                      ...
                      : homeNowMemory?.kind === "continuity" &&
                        ...
                        ? t("dailyMoment.concreteInsight.moodImproving")
                        : homeNowMemory?.kind === "continuity" &&
                            homeNowMemory.moodRecordCount >= 3 &&
                            homeNowMemory.moodDirection === "declining"
                          ? t("dailyMoment.concreteInsight.moodDeclining")
                          : homeNowMemory?.kind === "continuity" &&
                              homeNowMemory.moodRecordCount >= 3 &&
                              homeNowMemory.moodDirection === "stable"
                            ? t("dailyMoment.concreteInsight.moodStable")
                            : dailyContext.dailyLearningLevel === "learned_impulse"
                              ? t("dailyMoment.evolvingInsight.learnedImpulse")
                              : dailyContext.dailyLearningLevel === "effective_impulse"
                                ? t("dailyMoment.evolvingInsight.effectiveImpulse")
...
required_new = [
    ...
    't("dailyMoment.concreteInsight.checkIn"',
    't("dailyMoment.concreteInsight.moodImproving")',
    't("dailyMoment.concreteInsight.moodDeclining")',
    't("dailyMoment.concreteInsight.moodStable")',
]
...
# ============================================================
# 7. GARANTIR QUE 5D / 5C / 5B CONTINUAM PRESENTES
# ============================================================
...
# ============================================================
# 8. GARANTIR QUE NÃO FOI CRIADO NOVO BLOCO VISUAL
#
# Contagens estruturais da região 5D têm de permanecer.
# ============================================================
...
if not before_region or not after_region:
    fail(
...
# 11. TRADUÇÕES
#
# As quatro necessidades do Impulso recebem frases próprias.
#
# Não mostramos a contagem ao utilizador.
# A contagem serve apenas como requisito de evidência.
# ============================================================
...
# ============================================================
# 12. VALIDAR ESTRUTURA DAS TRADUÇÕES
# ============================================================
...
print("=" * 78)
print(
    "CONFIA — FASE 5E.2 / CURIOSIDADE CONCRETA"
)
print("=" * 78)
print()

print("✓ Uma única pista concreta por vez")
print("✓ Integrada no bloco visual existente da 5D")
print("✓ Nenhum novo cartão")
print("✓ Impulso exige repetição >= 2")
print("✓ Check-In exige repetição >= 2")
print("✓ Humor exige >= 3 registos")
print("✓ improving descrito como direção")
print("✓ declining descrito como direção")
...
print()
print("Backups:")
print("  /tmp/App.tsx.before_fase5e2_curiosidade_concreta")
print("  /tmp/pt.json.before_fase5e2_curiosidade_concreta")
print("  /tmp/en.json.before_fase5e2_curiosidade_concreta")
print("  /tmp/es.json.before_fase5e2_curiosidade_concreta")
print("  /tmp/fr.json.before_fase5e2_curiosidade_concreta")
print()
print("PRÓXIMO PASSO:")
print("  npm run build")
print("=" * 78)
