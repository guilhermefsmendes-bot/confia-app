          ...
          <div>
            ...
            {personalInterventionMemory && personalInterventionMemory.attempts >= 4 && (
              <div className="mb-4 rounded-[22px] border border-[#E5D7C7] bg-[#FFFBF4] p-4">
                <div className="flex items-start gap-3"><div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-[13px] bg-white"><Brain size={16} className="text-[#8A684E]" /></div><div><p className="text-[9px] font-black uppercase tracking-[0.14em] text-[#8A684E]">{t("sosLongitudinal.title")}</p><p className="mt-1 text-[11px] font-bold leading-5 text-[#51463F]">{t("sosLongitudinal.improved", { improved: personalInterventionMemory.improved, attempts: personalInterventionMemory.attempts })}</p><p className="mt-1 text-[9px] leading-4 text-[#8C817A]">{personalInterventionMemory.state === "changed" ? t("sosLongitudinal.changed") : t("sosLongitudinal.association")}</p></div></div>
              </div>
            )}
