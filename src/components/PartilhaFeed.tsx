...
const FEELINGS_LIST = [
  {
    ...
    text: 'Aliviado',
    emoji: '🌿',
    color: 'bg-[#FFF0E8] text-[#C97B5E] border-[#E5A88B]/20'
  },
  {
    key: 'feelingCalm',
    text: 'Calmo',
    emoji: '🧘‍♂️',
    color: 'bg-[#FAF5F0] text-[#8B5C4D] border-[#E5A88B]/15'
  },
  {
    key: 'feelingGrateful',
    text: 'Grato',
    emoji: '🥰',
    color: 'bg-[#FFF9F6] text-[#A06050] border-[#E5A88B]/15'
  },
  {
    key: 'feelingAnxious',
    text: 'Ansioso',
  ...
  },
  {
    ...
    text: 'Focado',
    emoji: '🎯',
    color: 'bg-white text-[#C97B5E] border-[#E5A88B]/20'
  }
];
...
export const PartilhaFeed: React.FC<PartilhaFeedProps> = ({
  ...
  const getFeelingStyles = (feeling: string) => {
    ...
    return found || {
      ...
      text: feeling,
      emoji: '💭',
      color: 'bg-[#FAF5F0] text-[#8B5C4D] border-slate-200'
    };
  };
    ...
    <div className="max-w-md mx-auto space-y-5 py-4">
      ...
      <div className="text-center px-4">
        <div className="flex items-center justify-center gap-2 mb-1">
          <span className="text-[#E5A88B] text-2xl">🤝</span>
          <h2 className="text-xl font-black text-[#4E3B36] font-display">
            {t("shareCornerTitle")}
          </h2>
        </div>
      ...
      {!showCompose ? (
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-xs font-bold text-[#4E3B36]">
                {t("howDoYouFeel")}
              </h3>
        ...
        >
          ...
          <div className="space-y-2">
            <label className="text-xs font-bold text-[#4E3B36] flex items-center gap-1">
              <Smile size={14} className="text-[#E5A88B]" />
              {t("currentFeeling")}
            </label>
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <h4 className="text-xs font-black text-[#4E3B36]">
                        {post.userName}
                      </h4>
