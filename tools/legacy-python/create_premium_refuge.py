...
path = Path("src/components/world/PremiumRefuge.tsx")

if path.exists():
    shutil.copy2(
        path,
        "/tmp/PremiumRefuge.tsx.before_1B4B1"
    )
...
print("=" * 72)
print("CONFIA — PREMIUM REFUGE 1B.4B.1")
print("=" * 72)
print("✓ PremiumRefuge criado")
print("✓ Utiliza getRefugeLevel existente")
print("✓ Níveis 1–5 respeitados")
print("✓ 0 XP preservado")
print("✓ 100 XP preservado")
print("✓ 500 XP preservado")
print("✓ 1000 XP preservado")
print("✓ 2000 XP preservado")
print("✓ SVG vetorial leve")
print("✓ Sem imagens externas")
print("✓ Sem bibliotecas")
print("✓ Sem animações permanentes")
print("✓ Sem novo armazenamento")
print("✓ Sem sistema de XP paralelo")
print("✓ Zero texto visível novo")
print("✓ PT / EN / ES / FR não afetados")
print()
print("IMPORTANTE:")
print("PremiumRefuge ainda NÃO foi ligado ao HomeWorld.")
print("FarmZones ainda NÃO foi alterado.")
print()
print("OK — componente criado isoladamente.")
